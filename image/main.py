...
from TrainTest import TrainTest,get_models,show_all_files_in_directory
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train', default=False,help='train model or not')
    parser.add_argument('--test', default=False,help='train model or not')
    ...
    check_and_create(args.base_path+'prediction')
    check_and_create(args.base_path+'swap')
